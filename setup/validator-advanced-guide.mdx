...
description: Use this playbook once you have the basics handled in the [Validator Simple Guide](/setup/validator-simple-guide). It focuses on production-ready configuration, reliability, and fine-grained control over validator behavior.
---
