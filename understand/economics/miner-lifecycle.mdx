title: "Miner Lifecycle & Performance — α Production and Liquidity Participation"
description: "How miners generate, bid, and recycle α through deterministic Epoch auctions in MetaHash SN73."
---

# Miner Lifecycle & Performance

Miners in MetaHash SN73 are α producers. They transform computational output from other subnets into tradable liquidity, then route that liquidity through SN73’s deterministic auctions to receive META. Participation hinges on positioning α at the right discount and maintaining consistent execution every 72-minute epoch.
