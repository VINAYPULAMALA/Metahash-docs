...
description: "MetaHash’s liquidity engine runs on α (alpha) — a measure of commitment, not a tradable token.Miners use α to bid for emissions each epoch, turning staking into a live auction that resets every 72 minutes."
---
