...
description: This advanced flow builds on the [Miner Simple Guide](/guides/miners/miner-simple-guide) and covers multi-bid strategies, payment routing, and automation flags that experienced operators typically rely on.
---
