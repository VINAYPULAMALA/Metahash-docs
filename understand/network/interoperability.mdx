...
# Subnet Interoperability & α Sharing

MetaHash SN73 acts as the liquidity router of the Bittensor subnet ecosystem. It provides a deterministic bridge that channels α between subnet producers, the treasury, and external liquidity participants so value generated anywhere can be exchanged, recycled, or rewarded without fragmentation.
