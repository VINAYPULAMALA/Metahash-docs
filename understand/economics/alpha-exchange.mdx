...
description: How MetaHash routes α through bidding, clearing, and reward recycling to price subnet access every epoch.
---

# The α Exchange Explained

MetaHash’s liquidity engine runs on α (alpha), a unit of commitment rather than a tradable token. α expresses how much value a miner is ready to deploy for access to emissions inside a given epoch. Instead of passive staking, miners constantly bid, clear, and recycle α, creating a live marketplace every 72 minutes.
...
3. Treasury returns cool-blue TAO rewards back to the miner.

That loop repeats every epoch — the economic heartbeat of MetaHash.

## Next Step

Head to [Treasury Structure](/understand/economics/treasury-structure) to see how collected α transforms into TAO payouts for miners and validators each epoch.
