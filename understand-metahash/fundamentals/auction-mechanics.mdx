...
**Actors:** Miners / α holders ([See Miner Guide →](/miners-validators-guide/miners/miner-advanced-guide))
...
**Actors:** Validators + Treasury ([Learn how validators rank bids →](/miners-validators-guide/validators/validator-advanced-guide))
...
**Actors:** Validators + Miners + Treasury ([Treasury Structure →](/understand-metahash/economics/treasury-structure))
...
| Discount (BPS) | Basis points system (100 bps = 1 %). [More on basis points →](/miners-validators-guide/miners/miner-advanced-guide#bid-controls) |
