...
description: "Understand how MetaHash SN73 routes subnet α across Bittensor through deterministic auctions, treasury coordination, and network interoperability."
---
...
<div style={{
  ...
  <p style={{
    ...
    MetaHash SN73 serves as Bittensor's liquidity coordination layer — transforming subnet output (α) into usable liquidity through validator-run deterministic auctions and routing that liquidity across the network's ecosystem of subnets and treasuries.
  </p>
</div>
...
- **Deterministic auctions:** predictable, validator-cleared α sales.
...
## 2. The Deterministic Auction System (360 Blocks)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{
        ...
        border: '1px solid rgba(255, 140, 0, 0.3)',
        background: 'rgba(255, 140, 0, 0.05)'
      }}>Bids are scored deterministically using the formula: Score = α_amount × (1 - discount).</td>
    </tr>
    <tr>
      <td style={{
        padding: '0.875rem 1rem',
