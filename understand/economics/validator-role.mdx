title: "Validator Role in MetaHash — Liquidity Allocation & Deterministic Settlement"
description: "How validators manage budgets, execute deterministic auctions, and maintain liquidity integrity within the MetaHash SN73 ecosystem."
---

# Validator Role in MetaHash

Validators in MetaHash SN73 act as liquidity allocators. They connect the treasury’s META budget with miners’ α supply, ensuring every 72-minute epoch clears deterministically and settles on-chain without discretionary intervention.

---

## Validator Mission

Each epoch begins with validators declaring META budget and discount caps. From there they coordinate the deterministic flow between miners and the treasury so α transactions settle without volatility, manual clearing, or opaque order books.

> Think of validators as rule-based market makers whose behavior is audited and enforced by consensus.
