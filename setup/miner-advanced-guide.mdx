...
description: In-depth tuning and operations guide for experienced MetaHash miners.
---

# Miner Advanced Guide

This advanced flow builds on the [Miner Simple Guide](/setup/miner-simple-guide) and covers multi-bid strategies, payment routing, and automation flags that experienced operators typically rely on.
