...
**Actors:** Miners / α holders ([See Miner Guide →](/miners-validators-guide/miners/miner-simple-guide))
...
**Actors:** Validators + Treasury ([Learn how validators rank bids →](/miners-validators-guide/validators/validator-simple-guide))
...
| Discount (BPS) | Basis points system (100 bps = 1 %). [More on basis points →](/miners-validators-guide/miners/miner-simple-guide#bps) |
