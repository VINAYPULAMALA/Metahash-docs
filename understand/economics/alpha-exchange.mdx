...
description: MetaHash’s liquidity engine runs on α (alpha), a unit of commitment rather than a tradable token. α expresses how much value a miner is ready to deploy for access to emissions inside a given epoch. Instead of passive staking, miners constantly bid, clear, and recycle α, creating a live marketplace every 72 minutes.
---
