...
# Treasury Structure — α → TAO Engine

The treasury is MetaHash’s settlement engine. Every epoch it ingests α from cleared auctions, converts that liquidity into TAO emissions, and returns rewards to the miners and validators who made the market. Its mandate is simple: keep rewards proportional to economic contribution while smoothing volatility across epochs.

## 1. Treasury Mission

1. **Proportional rewards** — TAO payouts mirror the α actually committed, not just static stake.
...
Continue to [Validator Role](/understand/economics/validator-role) to see how validators uphold fairness, finalize epochs, and keep the treasury transparent.
