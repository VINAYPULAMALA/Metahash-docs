  ...
  <tbody>
    <tr>
      <td style={{
        ...
        background: 'rgba(255, 140, 0, 0.05)',
        fontWeight: '600'
      }}><strong>Miners (e.g., subnet 62)</strong></td>
      <td style={{
        padding: '0.875rem 1rem',
        border: '1px solid rgba(255, 140, 0, 0.3)',
        background: 'rgba(255, 140, 0, 0.05)'
      }}>Sell α instantly at predictable prices.</td>
      <td style={{
        padding: '0.875rem 1rem',
        border: '1px solid rgba(255, 140, 0, 0.3)',
        background: 'rgba(255, 140, 0, 0.05)'
      }}>Offload surplus α through SN73 auctions.</td>
    </tr>
    <tr>
      <td style={{
        padding: '0.875rem 1rem',
        ...
        background: 'rgba(255, 140, 0, 0.05)',
        fontWeight: '600'
      }}><strong>Funds and validators</strong></td>
      <td style={{
        padding: '0.875rem 1rem',
        border: '1px solid rgba(255, 140, 0, 0.3)',
        background: 'rgba(255, 140, 0, 0.05)'
      }}>Access diversified α supply without managing multiple positions.</td>
      <td style={{
        padding: '0.875rem 1rem',
        border: '1px solid rgba(255, 140, 0, 0.3)',
        background: 'rgba(255, 140, 0, 0.05)'
      }}>Acquire discounted α from several subnets via SN73.</td>
    </tr>
    <tr>
      <td style={{
        padding: '0.875rem 1rem',
        ...
        background: 'rgba(255, 140, 0, 0.05)',
        fontWeight: '600'
      }}><strong>Subnet operators</strong></td>
      <td style={{
        padding: '0.875rem 1rem',
        border: '1px solid rgba(255, 140, 0, 0.3)',
        background: 'rgba(255, 140, 0, 0.05)'
      }}>Gain liquidity support and smoother reward payouts.</td>
      <td style={{
        padding: '0.875rem 1rem',
        border: '1px solid rgba(255, 140, 0, 0.3)',
        background: 'rgba(255, 140, 0, 0.05)'
      }}>Direct α output into SN73 as a liquidity sink.</td>
    </tr>
    <tr>
      <td style={{
        padding: '0.875rem 1rem',
        ...
        background: 'rgba(255, 140, 0, 0.05)',
        fontWeight: '600'
      }}><strong>SN73 holders</strong></td>
      <td style={{
        padding: '0.875rem 1rem',
        border: '1px solid rgba(255, 140, 0, 0.3)',
        background: 'rgba(255, 140, 0, 0.05)'
      }}>Capture yield from every subnet interacting with the treasury.</td>
      <td style={{
        padding: '0.875rem 1rem',
        border: '1px solid rgba(255, 140, 0, 0.3)',
        background: 'rgba(255, 140, 0, 0.05)'
      }}>Increased volume drives buybacks and treasury growth.</td>
    </tr>
  </tbody>
</table>
